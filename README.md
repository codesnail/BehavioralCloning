...
My final implementation used the "tiny data set" from Eric Lavigne taken from the slack channel. I also augmented this data further with recovery examples, details of which are provided below. 
